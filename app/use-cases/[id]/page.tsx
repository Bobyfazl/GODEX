...
import { ArrowRight, CheckCircle, Rocket, TrendingUp, Layers, Share2 } from 'lucide-react';
...
export default function UseCaseDetailPage() {
  ...
  if (!useCase) {
      if (typeof window !== 'undefined') router.replace('/use-cases');
      return null;
  }
                      ...
                      <div className="space-y-6 relative">
                          ...
                          {useCase.implementationSteps.map((step, i) => (
                              <div key={i} className="relative flex items-center gap-6">
                                  ...
                                  <div className="p-4 rounded-2xl bg-white/50 dark:bg-white/5 border border-white/50 dark:border-white/5 flex-1">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="mt-8 pt-6 border-t border-white/20">
                                <p className="text-sm text-white/70 leading-relaxed">
                                    * آمار فوق بر اساس میانگین نتایج پروژه‌های آزمایشی (Beta) گزارش شده است.
                                </p>
                            </div>
                        </div>
                    </div>
